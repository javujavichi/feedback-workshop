...
### Activities in chaos branches

This section lists different activities for the repository. Even when the code is not perfect it pretends to be treated as a real life project that was created by a lot of people collaborating together and now need to improve the architecture and organization of the project before adding a new domain.
...
This branch does have the test, but also is unorganized and to solve the mystery you need to place the files in the correct folders to pass the tests
